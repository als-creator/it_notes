...
- [Чек-лист новичка](#чек-лист-новичка)
- [Практика](#практика)
...
- [ ] Пишу заголовки `#`–`######` и знаю, зачем якоря
- [ ] Делаю маркированные и нумерованные списки, умею вложенность
- [ ] Выделяю `*курсив*`, `**жирный**`, `***`, `~~зачёркнутый~~`
- [ ] Вставляю ссылки (в т.ч. сноски) и картинки
- [ ] Использую инлайн-код и fenced-блоки с подсветкой языка
- [ ] Строю таблицы с выравниванием
- [ ] Цитирую через `>`, ставлю `---`
- [ ] Делаю чекбоксы `- [ ]` / `- [x]`
- [ ] Экранирую спецсимволы обратным слешем
- [ ] Отличаю перенос строки от нового абзаца
- [ ] Вставляю HTML (`<img width>`, `<details>`, `<br>` в таблицах)
- [ ] Собираю «Содержание» руками (якоря) или через `[TOC]`
- [ ] Знаю расширения: таблицы, чекбоксы, сноски, Mermaid
- [ ] Понимаю разницу CommonMark и GFM
- [ ] Пользуюсь как минимум одним редактором (Obsidian/Typora/VS Code)
